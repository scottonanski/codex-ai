...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ theme, onToggle }) => {
  return (
    <button
      onClick={onToggle}
      className="p-2 rounded-full text-codex-light-text-dim dark:text-codex-dark-text-dim hover:bg-codex-light-darker dark:hover:bg-codex-dark-lighter focus:outline-none focus:ring-2 focus:ring-codex-primary"
